...
import { getQuestion, updateQuestion } from '../services/forumService';
  ...
  const loadQuestion = async () => {
    try {
      ...
      if (response.success) {
        ...
        setLanguage(q.programmingLanguage || 'general');
        ...
        if (storedUser?.id !== q.author._id && storedUser?.role !== 'teacher') {
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold">Edit Question</span>
            </div>
          </div>
        </div>
      </header>
        ...
        >
          ...
          <div className="mb-6">
            ...
            >
              ...
              {showCodeEditor ? 'Hide Code Editor' : 'Add/Edit Code Snippet'}
            </button>
